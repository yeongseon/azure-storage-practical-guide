...
def generate_dashboard(tutorials: list[dict[str, Any]], today: date) -> str:
    ...
    lines.append("      justification: Auto-generated dashboard from tutorial validation frontmatter.")
    ...
    lines.append('    - claim: "This dashboard is generated from lab validation frontmatter."')
    lines.append('      source: "scripts/generate_validation_status.py"')
    lines.append("      verified: true")
    lines.append('    - claim: "Lab validation results are only marked pass when frontmatter records a tested method."')
