...
content_validation:
  ...
  reviewer: ai-agent
  core_claims:
  - claim: Learning Path guidance is based on linked Azure Storage source material.
    source: https://learn.microsoft.com/en-us/training/browse/?products=azure-storage
    verified: true
