...
content_validation:
  ...
  reviewer: ai-agent
  core_claims:
  - claim: Quick Diagnosis Cards guidance is based on linked Azure Storage source
      material.
    source: https://learn.microsoft.com/en-us/troubleshoot/azure/azure-storage/blobs/alerts/troubleshoot-storage-client-application-errors
    verified: true
