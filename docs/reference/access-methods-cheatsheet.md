...
content_sources:
  diagrams:
  - id: reference-access-methods-cheatsheet
    type: flowchart
...
content_validation:
  ...
  reviewer: ai-agent
  core_claims:
  - claim: Access Methods Cheatsheet guidance is based on linked Azure Storage source
      material.
...
<!-- diagram-id: reference-access-methods-cheatsheet -->
```mermaid
graph TD
